...
namespace Intercon.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240509160744_NotificationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intercon.Domain.Entities.CommentLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intercon.Domain.Entities.PerformanceLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<TimeSpan>("RequestDuration")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Intercon.Domain.Entities.ReviewLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BusinessId", "ReviewAuthorId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Intercon.Domain.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intercon.Domain.Notifications.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Description = "New like notification",
                            TypeName = "Like"
                        });
                });
            ...
            modelBuilder.Entity("Intercon.Domain.Entities.CommentLike", b =>
                {
                    b.HasOne("Intercon.Domain.Entities.Comment", "Comment")
                        .WithMany("Likes")
